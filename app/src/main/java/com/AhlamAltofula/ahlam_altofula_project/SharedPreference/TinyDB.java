...
public class TinyDB {
    ...
    public ArrayList<cart_products_model> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<cart_products_model> playerList =  new ArrayList<cart_products_model>();

        for(String jObjString : objStrings){
            cart_products_model player  = gson.fromJson(jObjString,  cart_products_model.class);
    ...
    public void putListObject(String key, ArrayList<cart_products_model> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(cart_products_model player: playerList){
